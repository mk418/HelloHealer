...
Bindings.defaults = {
    PRIEST = {
        ...
        { btn = 1, mod = "alt-shift",  spell = "Heal(Rank 3)" },
        ...
        { btn = 2, mod = "alt",        spell = "Resurrection" },
        { btn = 2, mod = "ctrl-shift", spell = "Fear Ward" },
        { btn = 2, mod = "alt-shift",  spell = "Renew(Rank 6)" },
    ...
    PALADIN = {
        ...
        { btn = 2, mod = "alt",        spell = "Redemption" },
